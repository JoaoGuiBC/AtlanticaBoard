...
export type GetProductQuery = { __typename?: 'Query', getProduct: { __typename?: 'Product', id: string, name: string, price: number, cost?: number | null, description?: string | null } };
